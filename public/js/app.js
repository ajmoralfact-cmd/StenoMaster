...
class StenoApp {
  ...
  async openPractice(passageId) {
    try {
      ...
      document.getElementById('practiceLanguageBadge').textContent = this.currentPassage.language.toUpperCase();
      ...
      stenoAudioPlayer.loadAudio(
        ...
        this.currentPassage.official_text,
